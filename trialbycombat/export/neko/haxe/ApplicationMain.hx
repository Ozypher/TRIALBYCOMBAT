...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("trialbycombat", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("trialbycombat", null, 640, 480);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["file"] = "trialbycombat";
		app.meta["name"] = "trialbycombat";
